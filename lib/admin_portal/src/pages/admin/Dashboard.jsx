...
function StatCard({ title, value, Icon, borderColor = 'border-gray-200' }) {
  ...
  return (
    ...
    >
      ...
      <span className="mt-4 text-3xl font-semibold text-gray-800">{value}</span>
    </div>
  );
}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-12">
        {charts.statusDistribution.labels.length > 0 && (
          <div className="bg-white rounded-3xl shadow-xl p-8">
            <h2 className="text-xl font-semibold mb-6">Cleanups by Status</h2>
            <Pie data={charts.statusDistribution} options={{ responsive: true }} />
          </div>
        )}

        {charts.monthlyTrends.labels.length > 0 && (
          <div className="bg-white rounded-3xl shadow-xl p-8">
            <h2 className="text-xl font-semibold mb-6">Monthly Cleanup Trends</h2>
            <Bar data={charts.monthlyTrends} options={{ responsive: true, plugins: { legend: { display: false } } }} />
          </div>
        )}
        ...
        {charts.wasteTypes.labels.length > 0 && (
          <div className="bg-white rounded-3xl shadow-xl p-8">
            <h2 className="text-xl font-semibold mb-6">Waste Type Distribution</h2>
            <Doughnut data={charts.wasteTypes} />
          </div>
        )}
      </div>
