...
//sabirin trying to update the code
// lib/views/profile_tab.dart
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        labelStyle: TextStyle(
          color: enabled ? const Color(0xFF3CAC44) : Colors.grey,
                  ...
                  child: CircleAvatar(
                    ...
                    child: _isUploadingImage
                        ? const CircularProgressIndicator(
                            valueColor: AlwaysStoppedAnimation(Color(0xFF3CAC44)),
                          )
                        : (_pickedImage != null
                            ? ClipOval(
                                child: Image.file(
                                        ...
                                        return Center(
                                          child: CircularProgressIndicator(
                                            value: loadingProgress.expectedTotalBytes != null
                                                ...
                                                : null,
                                            valueColor: const AlwaysStoppedAnimation(Color(0xFF3CAC44)),
                                          ),
                                        );
                                      },
